...
/**
 * 重写 {@link org.apache.kafka.clients.consumer.ConsumerConfig}
 *
...
public class ConsumerConfig extends AbstractConfig {
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG,
                ...
                .define(GROUP_ID_CONFIG, ConfigDef.Type.STRING, null, ConfigDef.Importance.HIGH, GROUP_ID_DOC)
    ...
    public static Map<String, Object> addDeserializerToConfig(Map<String, Object> configs,
        ...
        // -------------------- 源码修改start --------------------
        Map<String, Object> newConfigs = new HashMap<>(buildConfig(configs));
        // -------------------- 源码修改end --------------------
    ...
    private static String consumerInterceptor = "com.minister.framework.debug.kafka.interceptor.DebugConsumerInterceptor";

    /**
     * 加入调试拦截器
     */
    public static Map<String, Object> buildConfig(Map<String, Object> props) {
        boolean b = false;
        try {
            Class onwClass = Class.forName(consumerInterceptor);
            if (onwClass != null) {
                b = true;
            }
        } catch (Exception e) {
        ...
        //加入拦截
        Object object = props.get(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG);
        if (object == null) {
            List<String> cls = new ArrayList<>();
            cls.add(consumerInterceptor);
            props.put(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG, cls);
        } else if (object instanceof List) {
            List<String> cls = (List<String>) object;
            if (!cls.contains(consumerInterceptor)) {
                cls.add(consumerInterceptor);
            }
        } else {
            List<String> cls = new ArrayList<>();
            if (!object.toString().equals(consumerInterceptor)) {
                cls.add((String) object);
                cls.add(consumerInterceptor);
            } else {
                cls.add((String) object);
            }
